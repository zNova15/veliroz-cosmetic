...
/* ============================================================
   Veliroz Cosmetic — /cosmetic/blog
...
export default function BlogIndexPage() {
  ...
  const jsonLd = {
    ...
    blogPost: posts.map((p) => ({
      ...
      url: `${SITE}/cosmetic/blog/${p.frontmatter.slug}`,
    })),
  };
  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 md:px-10 pb-32 text-center space-y-6">
        ...
        <div className="pt-2">
          <Link href="/cosmetic/quiz" className="btn-primary">
            Empezar el quiz →
          </Link>
        </div>
      </section>
...
function PostCard({ post }: { post: BlogPostMeta }) {
  ...
  return (
    <Link
      href={`/cosmetic/blog/${frontmatter.slug}`}
